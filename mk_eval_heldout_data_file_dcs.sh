...
deepspeed --master_port $(($RANDOM % 1000 + 3000))1 --module openrlhf.cli.train_ppo --pretrain HuggingFaceTB/SmolLM-135M-Instruct --reward_pretrain OpenAssistant/reward-model-deberta-v3-large-v2 --save_path /h/319/stephenzhao/OpenRLHF/checkpoint/rlhfmulti --logging_steps 1 --eval_steps -1 --micro_train_batch_size 500 --train_batch_size 500 --micro_rollout_batch_size 25 --rollout_batch_size 25 --duplicate_rollout_batch_by 20 --max_epochs 1 --prompt_max_len 1024 --generate_max_len 20 --zero_stage 2 --prompt_data Silent-Zebra/a20k_2_heldout --input_key prompt --apply_chat_template --max_samples 100000 --save_info_path /h/319/stephenzhao/OpenRLHF/info/rlhfmulti --n_samples_per_prompt 1 --rm_type toy_rlhf --seed 1 --parameterization policy --load_checkpoint --only_evaluate_do_sampling --sampling_iters 1 --save_negdata_threshold -5 --ckpt_path ${CKPT_PATH}
EOL
