...
def get_info_name_str(args):
    ...
    if getattr(args, 'actor_loss_entropy_bonus', None) is not None:
        start_eb = getattr(args, 'start_actor_loss_entropy_bonus', None)
        if start_eb is not None:
            sched_type = getattr(args, 'actor_loss_entropy_bonus_schedule', 'log')
