...
class CombinedHarmlessnessTrainer(ABC):
    ...
    def make_experience_and_do_update(self, args, custom_prompt, pbar, rand_prompts, rewards_list,
        ...
        # Note: latest_sis_weights is updated each step but NOT accumulated here.
        # SIS weights history is collected per fit_step in train_ppo.py to match
        # the saving interval of other metrics (analytic KL, etc.).
