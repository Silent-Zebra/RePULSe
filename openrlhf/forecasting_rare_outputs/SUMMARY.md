...
*   **`elicitation.py`**:
    ...
    *   **Functionality:**
        ...
        *   Helper functions include `generate_output` (for `repeated_sampling`, with improved batching and error handling), `calculate_sequence_logprob` (for log-probability based methods).
